...
<body>
    <div class="sidebar">
        ...
        <div class="logout-btn nav-item"><a  href="../views/login.php">keluar sistem</a></div>
    ...
    <div class="main">
        ...
        <h1>Pilih Layanan</h1>
        <div class="menu-grid">
            <a class="card" href="lisbuku_user.php">
                <h3>📚 Kelola Buku</h3>
                <p>Cari dan lihat daftar buku tersedia</p>
            </a>
            <a class="card" href="buku_saya.php">
                <h3>🔄 Transaksi</h3>
                <p>Pinjam atau kembalikan buku</p>
            </a>
            <a class="card" href="profil.php">
                <h3>👥 Anggota</h3>
